...
<script> var priceUpdated = <?php echo $parameters['priceUpdated']; ?> </script>
	...
	<div class="fs-modal-body-inner">
		<form id="addAppointmentForm" class="position-relative">
            ...
            <div class="tab-content mt-5">
                <?php foreach ( TabUI::get( 'appointments_edit' )->getSubItems() as $tab ): ?>
                    <div class="tab-pane" data-tab-content="appointments_edit_<?php echo $tab->getSlug(); ?>" id="tab_<?php echo $tab->getSlug(); ?>"><?php echo $tab->getContent( ['id' => $parameters[ 'id' ]] ); ?></div>
                <?php endforeach; ?>
            </div>
		</form>
	</div>
