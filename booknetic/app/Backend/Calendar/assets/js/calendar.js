...
(function ($)
{
	...
	$(document).ready(function()
	{
		...
		let month_names = [
            ...
            booknetic.__('Nisan'),
            booknetic.__('Mayıs'),
            booknetic.__('Haziran'),
            booknetic.__('Temmuz'),
            booknetic.__('Ağustos'),
            booknetic.__('Eylül'),
            booknetic.__('Ekim'),
            booknetic.__('Kasım'),
            booknetic.__('Aralık')
		...
		FSCalendar = new FullCalendar.Calendar( $("#fs-calendar")[0],
		{
			...
			listDayFormat: function ( date )
			{
				let week_days = [
					booknetic.__('Pazar'),
                    booknetic.__('Pazartesi'),
                    booknetic.__('Salı'),
                    booknetic.__('Çarşamba'),
                    booknetic.__('Perşembe'),
                    booknetic.__('Cuma'),
                    booknetic.__('Cumartesi')
				];
