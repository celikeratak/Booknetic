...
<?php if ( ! empty( $parameters[ 'data' ][ 'items' ] ) ): ?>
    ...
    <div class="pagination row mt-4">
        <div class="col-md-12 d-flex flex-sm-row flex-column align-items-center justify-content-between">
            ...
            <a href="<?php echo htmlspecialchars( 'https://www.booknetic.com/documentation/' ); ?>" class="need_help_btn" target="_blank"><i class="far fa-question-circle"></i> <?php echo bkntc__( 'Need Help?' ); ?></a>
        </div>
    </div>
<?php else: ?>
