...
<div class="booknetic_appointment<?php echo Helper::isRTLLanguage( Permission::tenantId() ) ? " rtl": "" ?>" id="booknetic_theme_<?php echo $theme_id;?>" data-info="<?php echo $info ?>" data-steps="<?php print htmlspecialchars(json_encode( $stepsArr ))?>">
