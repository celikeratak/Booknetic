...
class SignInSaaS extends ET_Builder_Module {

	public $slug       = 'booknetic_saas_signin';
	...
	public function init() {
		$this->name = bkntc__( 'Booknetic Sign In SaaS');
	...
	public function render( $attrs, $content = null, $render_slug ) {
        return do_shortcode( "[booknetic-saas-signin]" );
	}
}
