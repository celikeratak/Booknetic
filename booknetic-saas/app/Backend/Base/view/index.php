        ...
        <?php if ( Permission::isSuperAdministrator() ): ?>
            <div class="booknetic_help_center_icon">
                ...
                <div class="booknetic_help_center_dropdown" style="display: none">
                    <script>
                        let other_element_clicked = true;

                        $( '.booknetic_help_center_icon' ).on( 'click', function ()
                        {
                            other_element_clicked = false;
                            $( '.booknetic_help_center_dropdown' ).toggle();
                        });

                        $( 'html' ).click( function ()
                        {
                            if ( other_element_clicked )
                            {
                                $( '.booknetic_help_center_dropdown' ).hide();
                            }

                            other_element_clicked = true
                        });
                    </script>
                    ...
                    <div class="booknetic_help_center_dropdown_body">
                        <div class="booknetic_contact_us booknetic_help_center_category">
                            <p class="booknetic_help_center_category_text"><?php echo bkntcsaas__( "Contact Us" ) ?></p>
                            <div class="booknetic_discord_wrapper booknetic_item" href="https://discord.com/invite/CGaDJHDvDS">
                                ...
                                <a class="booknetic_discord_text booknetic_help_center_item_text" target="_blank" href="https://discord.com/invite/CGaDJHDvDS"><?php echo bkntcsaas__( "Discord community" ) ?></a>
                            </div>
                            <div class="booknetic_contact_support_wrapper booknetic_item">
                                ...
                                <a class="booknetic_contact_support_text booknetic_help_center_item_text" target="_blank" href="https://support.fs-code.com/login"><?php echo bkntcsaas__( "Contact support" ) ?></a>
                            </div>
                        </div>
                        <div class="booknetic_get_informed booknetic_help_center_category">
                            <p class="booknetic_help_center_category_text"><?php echo bkntcsaas__( "Get informed" ) ?></p>
                            <div class="booknetic_documentation_wrapper booknetic_item">
                                ...
                                <a class="booknetic_documentation_text booknetic_help_center_item_text" target="_blank" href="https://www.booknetic.com/documentation"><?php echo bkntcsaas__( "Documentation" ) ?></a>
                            </div>
                            <div class="booknetic_faq_wrapper booknetic_item">
                                ...
                                <a class="booknetic_faq_text booknetic_help_center_item_text" target="_blank" href="https://www.booknetic.com/faq"><?php echo bkntcsaas__( "FAQ" ) ?></a>
                            </div>
                            <div class="booknetic_blog_wrapper booknetic_item">
                                ...
                                <a class="booknetic_blog_text booknetic_help_center_item_text" target="_blank" href="https://www.booknetic.com/blog"><?php echo bkntcsaas__( "Blog" ) ?></a>
                            </div>
                        </div>

                        <?php if ( ! Helper::getOption( 'joined_beta', false ) ): ?>
                            <div class="booknetic_join_beta booknetic_help_center_category">
                                <p class="booknetic_help_center_category_text"><?php echo bkntcsaas__( "Join beta" ) ?></p>
                                <div class="booknetic_join_beta_wrapper booknetic_item">
                                    ...
                                    <p class="booknetic_join_beta_text booknetic_help_center_item_text"><?php echo bkntcsaas__( "Join beta" ) ?></p>
                                </div>
                            </div>
                        <?php endif; ?>
