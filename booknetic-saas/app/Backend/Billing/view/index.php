...
<div id="payment_pending_popup"<?php echo (Helper::_get('payment_status', '', 'string') == 'pending' ? '' : ' class="hidden"')?>>
    <div class="payment_pending_popup_body">
        ...
        <div class="payment_pending_footer">
            <button type="button" class="btn btn-primary close_payment_pending_popup"><?php echo bkntcsaas__('CLOSE')?></button>
        </div>
    </div>
</div>
